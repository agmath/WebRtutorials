...
tutorial:
  id: "InferenceCategoricalLab.Topic13.webr.AppliedStats"
  version: 1.0
format: 
  html:
    progressive: TRUE
...
description: "In this lab, we work with survey data from a 2012 WIN-Gallup poll on the global rise of atheism. The `inference()` function from the `{statsr}` package is introduced. If you are working on a free-tiered Posit Cloud account, consider completing the part A and B versions of this notebook instead of this single, larger notebook to avoid RAM overflow on relaunch."
---
