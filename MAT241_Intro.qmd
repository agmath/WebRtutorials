...
I've set up this page to read in the data and draw a couple of pictures -- feel free to mess around and make changes. If you "break" something or write/change code that results in an error, no worries -- you can always reset the code chunk with the reset button. 
